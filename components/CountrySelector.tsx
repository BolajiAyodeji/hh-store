        ...
        >
          ...
          >
            <ul
              ...
              className="max-h-56 rounded-md py-1 text-base ring-1 ring-yellow-900 ring-opacity-5 overflow-auto focus:outline-none sm:text-sm"
            >
              {optionComponents.map(({ value, name, image, defaultLocale }, key) => {
                ...
                return (
                  <li
                    ...
                    className={`cursor-default select-none relative py-2 pl-3 pr-9 hover:text-gray-50 hover:bg-yellow-900 ${
                      selected ? "" : "text-yellow-900"
                    }`}
                  ...
                  >
                    ...
                    <span
                      className={`${
                        selected ? "text-yellow-900" : "hidden"
                      } absolute inset-y-0 right-0 flex items-center pr-4 hover:bg-yellow-900`}
                    >
                      <svg
                        className="h-5 w-5"
                        xmlns="http://www.w3.org/2000/svg"
